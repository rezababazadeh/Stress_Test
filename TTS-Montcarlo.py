...
for iter in range(Max_iter):
    ...
    opt_value_obj = m.obj()
    TTS_values.append(opt_value_obj)


print("Lostmargin values:", TTS_values)
...
mean1, lower1, upper1 = confidence_interval(TTS_values)

# Print results
print(f"TTS_values: Mean = {mean1:.2f}, 95% Confidence Interval = ({lower1:.2f}, {upper1:.2f})")
