...
# Initialize storage for objective
Lostmargin_values = []
PGHG_values = []
TGHG_values = []
SI_values = []
...
for iter in range(Max_iter):
    ...
    Lostmargin_values.append(opt_value_obj1)
    ...
    PGHG_values.append(pghgvalue)
    TGHG_values.append(tghgvalue)
    ...
    SI_values.append(opt_value_obj3)

PGHG_values1 = [value(expr) for expr in PGHG_values]
TGHG_values1 = [value(expr) for expr in TGHG_values]

print("Lostmargin values:", Lostmargin_values)
print("PGHG values:", PGHG_values1)
print("TGHG values:", TGHG_values1)
print("SI values:", SI_values)

# Calculate the confidence levels (standard deviations in this simple case)
...
mean1, lower1, upper1 = confidence_interval(Lostmargin_values)
mean2, lower2, upper2 = confidence_interval(PGHG_values1)
mean3, lower3, upper3 = confidence_interval(TGHG_values1)
mean4, lower4, upper4 = confidence_interval(SI_values)

# Print results
print(f"Lostmargin_values: Mean = {mean1:.2f}, 95% Confidence Interval = ({lower1:.2f}, {upper1:.2f})")
print(f"PGHG_values: Mean = {mean2:.2f}, 95% Confidence Interval = ({lower2:.2f}, {upper2:.2f})")
print(f"TGHG_values: Mean = {mean3:.2f}, 95% Confidence Interval = ({lower3:.2f}, {upper3:.2f})")
print(f"SI_values: Mean = {mean4:.2f}, 95% Confidence Interval = ({lower4:.2f}, {upper4:.2f})")



#Results in box plot
# Combine all data sets into a list
data = [Lostmargin_values, PGHG_values1, TGHG_values1, SI_values]
